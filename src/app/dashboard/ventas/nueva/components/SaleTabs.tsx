...
export default function SaleTabs({
  ...
  return (
    <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-hide">
      ...
      <button
        onClick={onNewTab}
        className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 hover:bg-blue-50 text-gray-400 hover:text-blue-600 transition-all border border-transparent hover:border-blue-200 ml-1"
