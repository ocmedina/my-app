          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                ...
                className="px-5 py-2.5 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-lg hover:from-gray-200 hover:to-gray-300 transition-all shadow-sm hover:shadow-md font-medium flex items-center gap-2"
              >
                <FaArrowLeft /> Volver al Historial
              </Link>

              {loadingCheck ? (
                <span className="px-5 py-2.5 text-gray-500 flex items-center gap-2 bg-gray-100 rounded-lg">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tfoot className="bg-gradient-to-r from-blue-50 to-purple-50">
                <tr>
                  <td
                    colSpan={3}
                    className="px-6 py-4 text-right text-base font-bold text-gray-900 uppercase"
                  >
                    Total de la Venta
                  </td>
