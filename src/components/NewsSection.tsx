      ...
      {isExpanded && (
        <div className="px-6 pb-6 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
            <div className="bg-white/10 rounded-lg p-3 backdrop-blur-sm">
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="font-semibold text-sm">Gestión de Órdenes</p>
              </div>
            ...
            <div className="bg-white/10 rounded-lg p-3 backdrop-blur-sm">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-lg">📊</span>
                <p className="font-semibold text-sm">Stock Automático</p>
              </div>
              <p className="text-xs text-blue-100">
            ...
            <div className="bg-white/10 rounded-lg p-3 backdrop-blur-sm">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-lg">📱</span>
                <p className="font-semibold text-sm">Envío por WhatsApp</p>
              </div>
              <p className="text-xs text-blue-100">
          ...
          <Link
            ...
            className="w-full bg-white/20 hover:bg-white/30 text-white font-semibold py-2.5 px-4 rounded-lg transition-all flex items-center justify-center gap-2 backdrop-blur-sm border border-white/30"
          >
